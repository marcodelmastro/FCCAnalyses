...
outputDir = 'outputs/fccee/higgs/mH-recoil/neutrinos/llvvjj/final/woutfilter_score_6classes_llvvjj/' 
...
def main(): 
    ...
    hw1 = 5*10**(6)*hw1
    hw2 = 5*10**(6)*hw2
    fileWWsel5 = ROOT.TFile.Open(f"{outputDir}WWnorm_sel5_{var}.root", "RECREATE")
    fileWWsel5.WriteObject(hw1, "myScore_new_zoom")
    fileWWsel0 = ROOT.TFile.Open(f"{outputDir}WWnorm_sel0_{var}.root", "RECREATE")
    fileWWsel0.WriteObject(hw2, "myScore_new_zoom")
