...
inputDir = 'outputs/fccee/higgs/mH-recoil/neutrinos/llvvjj/final/cutshisto/'
outputDir = 'outputs/fccee/higgs/mH-recoil/neutrinos/llvvjj/plots/opti/'
...
var = ['dmerge_2_23'] #par exemple, mais osef
sels = ['sel0', 
	'sel1',
	'sel2',
	'sel3', 
...
def main():
    n = len(sels)
    print(n)
    h = ROOT.TH1F("cutssoversqrtb", "S over sqrtB as a function of the value of the cut on dmerge23", n+1, 0, n+1)
    xax = h.GetXaxis()
    for i in range(0,n):
        print(i)
        sums = 0 
