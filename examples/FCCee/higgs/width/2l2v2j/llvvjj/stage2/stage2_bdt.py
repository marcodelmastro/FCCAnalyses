...
outputDir   = "outputs/fccee/higgs/mH-recoil/neutrinos/llvvjj/stage2/bdt/woutfilter/"
...
processList = {'wzp6_ee_mumuH_HZZ_ecm240':{},
            ...
            #  # 'wzp6_ee_ee_Mee_30_150_ecm240':{},
               'p8_ee_ZZ_ecm240':{},#Run the full statistics in one output file name <outputDir>/p8_ee_ZZ_ecm240.root
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (df
               ...
               #.Filter("abs_pdg_Z1 == 12 || abs_pdg_Z1 == 14 || abs_pdg_Z1 == 16") 
