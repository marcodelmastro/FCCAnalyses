...
inputDir  = "outputs/fccee/higgs/mH-recoil/neutrinos/lljjvv/stage2/smear_sf_2_5/"

#Input directory where the files produced at the pre-selection level are
outputDir  = "outputs/fccee/higgs/mH-recoil/neutrinos/lljjvv/final/smear_sf_2_5/"
...
cutList = {"sel0":"Zcand_cos < 2", #aucun cut, 
           ...
           "sel6":"N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93",
           "sel7":"N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4",
           "sel8": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2",
           "sel9": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5",
           "sel10": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5 && dmerge_2_12 > 2000",
           
           "sel11": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5 && dmerge_2_12 > 2000 &&  dmerge_2_23 < 60 ",
           "sel12": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5 && dmerge_2_12 > 2000 && dmerge_2_23 > 60 ",


           "sel13": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 100 && secondZ_m > 60 && abs(cos(new_missing_theta)) < 0.93 && new_min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5 && dmerge_2_12 > 2000 && dmerge_2_23 > 60 && meanNconst_3 > 10 "
...
histoList = {
    ...
    "new_visible_mass_predef_zoom":{"name":"new_visible_mass_predef", "title":"Visible Mass [GeV]", "bin":100, "xmin":200, "xmax":240},
