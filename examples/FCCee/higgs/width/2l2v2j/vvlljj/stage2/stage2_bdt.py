...
outputDir   = "outputs/fccee/higgs/mH-recoil/neutrinos/vvlljj/stage2/bdt/woutfilter/"

processList = {'wzp6_ee_nunuH_HZZ_ecm240':{},
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (df
               ...
               #.Filter("abs_pdg_Z == 12 || abs_pdg_Z == 14 || abs_pdg_Z == 16") 
...
#maintenant, on est plus que sur des évènements où le Z seul est en leptons et le higgs en deux Z eux meme en 2 jets (4jets)
	       ...
	       .Define("missing_theta", "missing_tlv[0].Theta()") 
               ...
               .Filter("secondZ_m > 10")
               .Filter("secondZ_m < 60")
               .Filter("visible_mass_predef > 100")
               .Filter("visible_mass_predef < 150")
