...
inputDir  = "outputs/fccee/higgs/mH-recoil/neutrinos/vvlljj/stage2/"

#Input directory where the files produced at the pre-selection level are
outputDir  = "outputs/fccee/higgs/mH-recoil/neutrinos/vvlljj/final/"
...
cutList = {"sel0":"Zcand_cos < 2", #aucun cut, 
           ...
           "sel2":"N_selected_leptons ==2 && emiss > 25 && emiss < 75",
           "sel3":"N_selected_leptons ==2 && emiss > 25 && emiss < 75 && visible_mass_predef > 110 && visible_mass_predef < 140 ",
           "sel4":"N_selected_leptons ==2 && emiss > 25 && emiss < 75 && visible_mass_predef > 110 && visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60",
           "sel5":"N_selected_leptons ==2 && emiss > 25 && emiss < 75 && visible_mass_predef > 110 && visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5",
           "sel6":"N_selected_leptons ==2 && emiss > 25 && emiss < 75 && visible_mass_predef > 110 && visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5 && Zcand_m > 70 && Zcand_m < 100",
           "sel7":"N_selected_leptons ==2 && emiss > 25 && emiss < 75 && visible_mass_predef > 110 && visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5 && Zcand_m > 70 && Zcand_m < 100 && etmiss > 10",
           "sel8": "N_selected_leptons ==2 && emiss > 25 && emiss < 75 && visible_mass_predef > 110 && visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5 && Zcand_m > 70 && Zcand_m < 100 && etmiss > 10 && Zcand_recoil_m > 130",
           #"sel9": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 95 && secondZ_m > 64 && abs(cos(missing_theta)) < 0.93 && min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && emiss < 45 && emiss > 5",
           #"sel10": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 95 && secondZ_m > 64 && abs(cos(missing_theta)) < 0.93 && min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && emiss < 45 && emiss > 5 && dmerge_2_23 < 60 ",
           #"sel11": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 95 && secondZ_m > 64 && abs(cos(missing_theta)) < 0.93 && min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && emiss < 45 && emiss > 5 && dmerge_2_23 > 60 "
...
histoList = {
    ...
    "visible_mass_predef":{"name":"visible_mass_predef", "title":"Visible Mass [GeV]", "bin":100, "xmin":0, "xmax":300},
     "visible_mass_predef_zoom":{"name":"visible_mass_predef", "title":"Visible Mass [GeV]", "bin":100, "xmin":80, "xmax":150},
    "visible_mass_predef_centered":{"name":"visible_mass_predef", "title":"Visible Mass [GeV]", "bin":30, "xmin":110, "xmax":140},
