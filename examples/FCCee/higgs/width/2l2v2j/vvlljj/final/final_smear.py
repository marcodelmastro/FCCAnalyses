...
inputDir  = "outputs/fccee/higgs/mH-recoil/neutrinos/vvlljj/stage2/smear_sf_1_5/"

#Input directory where the files produced at the pre-selection level are
outputDir  = "outputs/fccee/higgs/mH-recoil/neutrinos/vvlljj/final/smear_sf_1_5/"
...
cutList = {"sel0":"Zcand_cos < 2", #aucun cut, 
           ...
           "sel2":"N_selected_leptons ==2 && newemiss > 25 && newemiss < 75",
           "sel3":"N_selected_leptons ==2 && newemiss > 25 && newemiss < 75 && new_visible_mass_predef > 110 && new_visible_mass_predef < 140 ",
           "sel4":"N_selected_leptons ==2 && newemiss > 25 && newemiss < 75 && new_visible_mass_predef > 110 && new_visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60",
           "sel5":"N_selected_leptons ==2 && newemiss > 25 && newemiss < 75 && new_visible_mass_predef > 110 && new_visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5",
           "sel6":"N_selected_leptons ==2 && newemiss > 25 && newemiss < 75 && new_visible_mass_predef > 110 && new_visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5 && Zcand_m > 70 && Zcand_m < 100",
           "sel7":"N_selected_leptons ==2 && newemiss > 25 && newemiss < 75 && new_visible_mass_predef > 110 && new_visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5 && Zcand_m > 70 && Zcand_m < 100 && newetmiss > 10",
           "sel8": "N_selected_leptons ==2 && newemiss > 25 && newemiss < 75 && new_visible_mass_predef > 110 && new_visible_mass_predef < 140 && secondZ_m > 10 && secondZ_m < 60 && meanNconst > 5 && Zcand_m > 70 && Zcand_m < 100 && newetmiss > 10 && Zcand_recoil_m > 130",
           #"sel9": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 95 && secondZ_m > 64 && abs(cos(missing_theta)) < 0.93 && min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5",
           #"sel10": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 95 && secondZ_m > 64 && abs(cos(missing_theta)) < 0.93 && min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5 && dmerge_2_23 < 60 ",
           #"sel11": "N_selected_leptons ==2 && Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 138 && meanNconst > 8 && secondZ_m < 95 && secondZ_m > 64 && abs(cos(missing_theta)) < 0.93 && min_angle_miss_jet > 0.4 && N_LooseLeptons_2 == 2 && newemiss < 45 && newemiss > 5 && dmerge_2_23 > 60 "

           
           #"sel9": "Zcand_m > 81 && Zcand_m < 101 && Zcand_recoil_m > 124 && Zcand_recoil_m < 140 && newemiss > 5 && secondZ_m < 40 && secondZ_m > 65 && dmerge_2_12 > 10 && dmerge_2_23 < 100 && secondZ_p < 40"
...
histoList = {
    ...
    "leptonic_recoil_m_zoom":{"name":"Zcand_recoil_m","title":"Leptonic recoil mass [GeV]","bin":15,"xmin":130,"xmax":160},
    ...
    "new_visible_mass_predef":{"name":"new_visible_mass_predef", "title":"Visible Mass [GeV]", "bin":100, "xmin":0, "xmax":300},
     "new_visible_mass_predef_zoom":{"name":"new_visible_mass_predef", "title":"Visible Mass [GeV]", "bin":100, "xmin":80, "xmax":150},
    "new_visible_mass_predef_centered":{"name":"new_visible_mass_predef", "title":"Visible Mass [GeV]", "bin":30, "xmin":110, "xmax":140},
    ...
    "dmerge_2_12":{"name":"dmerge_2_12","title":"dmerge_12","bin":125,"xmin":0,"xmax":8000},
    "dmerge_2_12_zoom":{"name":"dmerge_2_12","title":"dmerge_12 zoom","bin":125,"xmin":0,"xmax":1000},
    "dmerge_2_23":{"name":"dmerge_2_23","title":"dmerge_23","bin":125,"xmin":0,"xmax":700},
    ...
    "newemiss":{"name":"newemiss", "title":"Missing energy [GeV]", "bin":100, "xmin":0, "xmax":100},
    "newpxmiss":{"name":"newpxmiss", "title":"Missing px [GeV]", "bin":100, "xmin":-80, "xmax":80},
    "newpymiss":{"name":"newpymiss", "title":"Missing py [GeV]", "bin":100, "xmin":-80, "xmax":80},
    "newpzmiss":{"name":"newpzmiss", "title":"Missing pz [GeV]", "bin":100, "xmin":-80, "xmax":80},
    "newpzmiss_zoom":{"name":"newpzmiss", "title":"Missing pz [GeV]", "bin":100, "xmin":0, "xmax":60},
    "newetmiss":{"name":"newetmiss", "title":"Missing transverse energy [GeV]", "bin":100, "xmin":0, "xmax":100},
    "newetmiss_zoom":{"name":"newetmiss", "title":"Missing transverse energy [GeV]", "bin":100, "xmin":0, "xmax":60},



    "new_missing_theta":{"name":"new_missing_theta", "title":"#theta extracted from the missing tlv", "bin":100, "xmin":0, "xmax":4},
    "new_angle_miss_jet1":{"name":"new_angle_miss_jet1", "title":"angular difference between missing tlv and jet1", "bin":100, "xmin":0, "xmax":4},
    "new_angle_miss_jet2":{"name":"new_angle_miss_jet2", "title":"angular difference between missing tlv and jet2", "bin":100, "xmin":0, "xmax":4},
    "new_min_angle_miss_jet":{"name":"new_min_angle_miss_jet","title":"Minimal angular difference between missing tlv and jets", "bin":100, "xmin":0, "xmax":4},
    "new_max_angle_miss_jet":{"name":"new_max_angle_miss_jet", "title":"Maximal angular difference between missing tlv and jets", "bin":100, "xmin":0, "xmax":4},
